          ...
          <div className={`${styles.hero_section}`}>
            ...
            >
              ...
              <Col md={7} className={`${styles.text_3} fst-italic fw-light`}>
                "Nu este o adevărată justiție acolo unde nu există dreptate, iar
                dreptatea nu poate fi găsită acolo unde nu există adevăr." -{" "}
            ...
            <div className="card-body">
              ...
              <div className={`${styles.text_separator}`}>
                <p className={`${styles.text} px-3 pb-4`}>
                  ...
                  <br />
                  <span className={`${styles.first_letter} ps-2`}>V</span>rem să
                  fim alături de tine și să găsim cele mai bune soluții pentru
                  problemele tale menținând în același timp imaginea ta
              ...
              <Row className="mt-3 gx-3 flex-column flex-md-row">
                <Col md={6}>
                  ...
                  <p className={`${styles.services_text} pt-4 px-lg-5`}>
                    ...
                    muncii, dreptul familiei, procedura insolvenței, recuperări
                    creanțe, drept administrativ, etc.
                  </p>
                ...
                <Col md={6}>
                  ...
                  <p className={`${styles.services_text} pt-4 px-2 px-lg-5`}>
                    ...
                    administrativă, recuperări creanțe, evaluare și valorificare
                    active.
                  </p>
            ...
            <div className="card-body">
              ...
              <div className={`${styles.text_separator}`}>
                ...
                <p className="px-3 pb-4">
                  <span className={`${styles.first_letter} ps-2`}>V</span>om fi
                  partenerul dvs. în soluționarea într-un mod profesionist a
                  tuturor problemelor comerciale, fiscale, contractuale.
                  <br />
                  <span className={`${styles.first_letter} ps-2`}>S</span>untem
                  o echipă tânără de avocați, practicieni în insolvență și
                  economiști, specialiști în domeniul financiar-juridic, cu o
                  nouă viziune de abordare și soluționare a problemelor. Ne
                  recomandă experiența de peste 10 ani, profesionalismul și
                  seriozitatea.
                  <br />
                  <span className={`${styles.first_letter} ps-2`}>C</span>
                  oordonatorul Biroului de avocatură și insolvență, Marin Alina
                  este avocat de peste 15 ani, în domeniul comercial,
