      ...
      >
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="0">
          ...
          <Accordion.Body className={styles.body}>
            ...
            <p>
              ...
              Oficial, Partea I nr. 45 din 13/01/2005 intrat in vigoare la data
              de 13 ianuarie 2005; Capitolul III Activitatea profesionala a
              avocatului; Sectiunea a 2-a Relatiile dintre avocat si client;
            </p>
            <h5 className={styles.title}>Onorarii pentru persoane juridice:</h5>
            <p>
              În stabilirea onorariilor pentru persoane juridice avem în vedere,
              pe lângă principiile prezentate mai jos, posibilitatea de a
              dezvolta modalităţile de plată a onorariilor sub diferite aspecte
              cum sunt:
            </p>
            <ul>
              <li>onorariul fix</li>
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="1">
          ...
          <Accordion.Body className={styles.body}>
            ...
            <p>
              {" "}
              Insolventa, nu inseamna automat faliment,aceasta poate fi deschisa
              si in vederea reorganizarii societatii pe baza unui plan care
              poate conduce la redresarea afaceri si iesirea din insolventa.Doar
              in momentul in care reorganizarea da gres, se poate declansa
              falimentul.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="2">
          ...
          <Accordion.Body className={styles.body}>
            ...
            <p>
              Scopul insolventei nu este de a ajunge la faliment si de a inchide
              societatea, ci de a o ajuta sa se redreseze dupa un plan stabilit.
              Practic, se va deschide o procedura de insolventa generala cu
              intentia de a reorganiza societatea dupa un plan de reorganizare.
              Potrivit dispozițiilor art. 5 pct. 54. din Legea nr. 85/2014,
              reorganizarea este „procedura ce se aplica debitorului in
              insolventa, persoana juridica, in vederea achitarii datoriilor
              acestuia, conform programului de plata a creanțelor.
            </p>

            <p>
              Planul de reorganizare presupune intocmirea, aprobarea,
              confirmarea, implementarea și respectarea unui plan, care poate sa
              prevada:
            </p>
            <ul>
              <li>
            ...
            <p>
              Creditorii trebuie sa cunoasca ce sume vor primi din creantele pe
              care le detin impotriva averii debitorului și cand li se vor plati
              pentru a‑si face propria analiza economica.
            </p>
            <p>
              Prin pct. 53. din art. 5 se definește programul de plata a
              creanțelor ca fiind „graficul de achitare a acestora mentionat in
              planul de reorganizare. Doar in cazul in care acest plan de
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="3">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              Falimentul intervine ca o ultima solutie atunci cand redresarea si
              planul de reorganizare nu mai sunt posibile.
            </p>
            <p>
              ...
              acoperirea pasivului, urmata de radierea debitorului din registrul
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="4">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              ...
              obiectului de activitate, ci se pregateste doar pentru lichidarea
              patrimoniului
            </p>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="5">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              Lichidarea unei firme reprezinta totalitatea operatiunilor care au
              ca scop finalizarea operatiunilor comerciale aflate în curs la
              data dizolvarii societatii, transformarea bunurilor societatii in
              lichiditati, plata datoriilor acesteia, precum si impartirea
              activului net intre asociati. Dupa ramanerea definitiva a
              hotararii judecatoreşti de dizolvare, Oficiul National al
              Registrului Comertului, la cererea societatii, numeste, un
              lichidator judiciar inscris in Tabloul practicienilor in
              insolventa.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="6">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              Radierea presupune incetarea deplina a capacitatii de folosinta a
              societatii comerciale. Un aspect de retinut, in cazul radierii,
              este ca aceasta nu presupune eliminarea inregistrarii anterioare,
              ci doar consemnarea incetarii activitatii sale.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        {/* Fuziunea */}
        <Accordion.Item className={styles.accordion_item} eventKey="7">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              Fuziunea este operatia prin care una sau mai multe societati sunt
              dizolvate fara a intra în lichidare si transfera totalitatea
              patrimoniului lor unei alte societati in schimbul repartizarii
        ...
        <Accordion.Item className={styles.accordion_item} eventKey="8">
          ...
          <Accordion.Body className={styles.body}>
            <p>
              ...
              societati totalitatea patrimoniului sau, in schimbul repartizarii
              catre actionarii societatii divizate de actiuni la societatile
              beneficiare.
            </p>
            ...
            <ul>
              <li>
                Depunerea proiectului de fuziune și hotararea adunarii generale
                a societatii participante la fuziune ( prin care se renunță la
